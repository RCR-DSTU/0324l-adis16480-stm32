...
/*!
	General function
*/
void adis16480_calibration_end(adis16480_t *);
...
void adis16480_get_acceleration(adis16480_t *, float *);

float adis16480_get_acceleration_x(adis16480_t *);

float adis16480_get_acceleration_y(adis16480_t *);

float adis16480_get_acceleration_z(adis16480_t *);

void adis16480_get_angular_velocity(adis16480_t *, float *);

float adis16480_get_angular_velocity_x(adis16480_t *);

float adis16480_get_angular_velocity_y(adis16480_t *);

float adis16480_get_angular_velocity_z(adis16480_t *);

void adis16480_get_magnetic_field(adis16480_t *, float *);

float adis16480_get_magnetic_field_x(adis16480_t *);

float adis16480_get_magnetic_field_y(adis16480_t *);

float adis16480_get_magnetic_field_z(adis16480_t *);

void adis16480_get_euler_angles(adis16480_t *, float *);

float adis16480_get_magnetic_course(adis16480_t *);
